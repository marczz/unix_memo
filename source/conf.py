...
# -*- coding: utf-8 -*-
#
# Unix Memo documentation build configuration file.
#
...
man_pages = [
    ('index', 'unixmemos', 'Unix Memos Collection',
     ['Marc Zonzon'], 1)
]
...
texinfo_documents = [
  ('index', 'UnixMemos', 'Unix Memos Collection',
   'Marc Zonzon', 'UnixMemos', 'Collection of UNIX administration memos..',
   'Miscellaneous'),
]
...
epub_title = 'Unix Memos'
epub_author = 'Marc Zonzon'
epub_publisher = 'Marc Zonzon'
epub_copyright = '2012-2014 Marc Zonzon'

# The basename for the epub file. It defaults to the project name.
#epub_basename = 'Unix Memos'
...
extlinks = {
    ...
    'bsdman':('http://man.openbsd.org/OpenBSD-current/man/%s', ''),
    'coreutils':(
